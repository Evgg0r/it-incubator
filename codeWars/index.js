...
//     const digits = Math.abs(number).toString().length; // Получаем количество цифр в числе
//     const power = Math.pow(5, digits); // Возведение 5 в степень количества цифр
//     return number * power; // Умножение числа на 5, возведенное в степень количества цифр
// }
...
// Create a
// function that always returns True / true
// for every item in a given list.
// However,
...
//     "flick"
// will always be given in lowercase.
